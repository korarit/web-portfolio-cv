            ...
            <div className="flex gap-x-3">
              ...
              <div className="grow pt-0.5 pb-8">
                ...
                <p className="mt-1 text-base text-[#bdbdbd]">
                  ...
                  โปรเจคของผมก็จะเน้นให้งานสามารถใช้งานได้จริง ๆ พร้อมที่จะใช้งานมากที่สุด ทำเท่าที่คิดว่าตัวเองทำได้ พยายามทะลุขีดจำกัดในความรู้ของตัวเอง เพื่อให้เกิดการเรียนรู้สิ่งใหม่ ๆ
                </p>
              </div>
            </div>
